...
export const WireTracking: React.FC = () => {
  ...
  const [wireAmt, setWireAmt]     = useState<number | null>(null)
  ...
  const confirmWire = () => {
    ...
    if (wireModal) {
      recordWirePayment(wireModal.investorId, wireConf.trim(), wireAmt ?? undefined, wireDate || undefined)
